  ...
  return (
    <li className="mb-12">
      <ExternalLink url={link} className={"!text-night"} colored={false}>
        <div className=" group relative grid scale-100 pb-1 transition-all duration-200 ease-in-out sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!scale-105 lg:hover:!opacity-100 lg:group-hover:scale-75 lg:group-hover/list:opacity-50">
